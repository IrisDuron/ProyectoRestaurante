    ...
    public class DetalleFacturaRepositorio : IDetalleFacturaRepositorio
    {
        ...
        public async Task<bool> Nuevo(DetalleFactura detalleFactura)
        {
            ...
            try
            {
                ...
                string sql = @"INSERT INTO detallefactura (IdFactura, CodigoMenu, Descripcion, Cantidad, Precio, Subtotal, ISV, Total) VALUES (@IdFactura, @CodigoMenu, @Descripcion, @Cantidad, @Precio, @SubTotal, @ISV, @Total);";
