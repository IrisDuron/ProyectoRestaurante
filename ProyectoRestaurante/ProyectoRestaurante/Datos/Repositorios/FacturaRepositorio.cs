    ...
    public class FacturaRepositorio : IFacturaRepositorio
    {
        ...
        public async Task<int> Nueva(Factura factura)
        {
            ...
            try
            {
                ...
                string sql = @"INSERT INTO factura (IdentidadCliente, Cliente, Fecha) VALUES (@IdentidadCliente, (SELECT Nombre FROM Cliente Where IdentidadCliente = @IdentidadCliente;) , @Fecha); SELECT LAST_INSERT_ID()";
